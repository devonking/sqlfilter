 ...
 *
 * For example:
 *  helper.and("x", 1).begin().and("y", 2).or("z", 3).end();
 *  ==>
 *      x = '1' AND (y = '2' OR z = '3')
 *
 *  helper.and("x", 1).begin().or("y", 2).or("z", 3).end();
 *  ==>
 *      x = '1' OR (y = '2' OR z = '3')
 *
 *
...
public class FilterHelper {
    ...
    public FilterHelper and(String key, Object value) {
        if(value instanceof Operator) {
            ...
            return and(key, Operator.EQUAL_TO, value);
        }
    }
    ...
    public FilterHelper and(String key, Operator operator, Object value) {
        ...
        currentGroup.and(new Filter(key, operator, value));
    ...
    public FilterHelper or(String key, Object value) {
        if(value instanceof Operator) {
            ...
            return or(key, Operator.EQUAL_TO, value);
        }
    }
    ...
    public FilterHelper or(String key, Operator operator, Object value) {
        ...
        currentGroup.or(new Filter(key, operator, value));
